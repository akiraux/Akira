...
namespace Goo {
	[CCode (cheader_filename = "goocanvas.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "goo_cairo_matrix_get_type ()")]
	[Compact]
	public class CairoMatrix {
		public static Cairo.Matrix? copy (Cairo.Matrix matrix);
		public static void free (Cairo.Matrix matrix);
	}
	[CCode (cheader_filename = "goocanvas.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "goo_cairo_pattern_get_type ()")]
	[Compact]
	...
	public class Canvas : Gtk.Container, Atk.Implementor, Gtk.Buildable, Gtk.Scrollable {
		...
		public static void marshal_BOOLEAN__DOUBLE_DOUBLE_BOOLEAN_OBJECT (GLib.Closure closure, GLib.Value return_value, uint n_param_values, GLib.Value param_values, void* invocation_hint, void* marshal_data);
	...
	public class CanvasText : Goo.CanvasItemSimple, Goo.CanvasItem {
		...
		public static unowned Goo.CanvasText create (Goo.CanvasItem? parent, string str, double x, double y, double width, int anchor, ...);
	...
	[CCode (cheader_filename = "goocanvas.h")]
	public static unowned GLib.ParamSpec canvas_item_class_find_child_property (GLib.ObjectClass iclass, string property_name);
	[CCode (cheader_filename = "goocanvas.h")]
	public static void canvas_item_class_install_child_property (GLib.ObjectClass iclass, uint property_id, GLib.ParamSpec pspec);
	[CCode (array_length_pos = 1.1, array_length_type = "guint", cheader_filename = "goocanvas.h")]
	public static GLib.ParamSpec[] canvas_item_class_list_child_properties (GLib.ObjectClass iclass);
	[CCode (cheader_filename = "goocanvas.h")]
	public static unowned GLib.ParamSpec canvas_item_model_class_find_child_property (GLib.ObjectClass mclass, string property_name);
	[CCode (cheader_filename = "goocanvas.h")]
	public static void canvas_item_model_class_install_child_property (GLib.ObjectClass mclass, uint property_id, GLib.ParamSpec pspec);
	[CCode (array_length_pos = 1.1, array_length_type = "guint", cheader_filename = "goocanvas.h")]
	public static (unowned GLib.ParamSpec)[] canvas_item_model_class_list_child_properties (GLib.ObjectClass mclass);
}
