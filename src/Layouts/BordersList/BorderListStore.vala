...
public class Akira.Layouts.BordersList.BorderListStore : VirtualizingListBoxModel {
    ...
    private GLib.Sequence<BorderItemModel> data = new GLib.Sequence<BorderItemModel> ();
    private uint last_position = uint.MAX;
    private GLib.SequenceIter<BorderItemModel>? last_iter;
    private unowned GLib.CompareDataFunc<BorderItemModel> compare_func;
    ...
    private GLib.Object? get_item_internal (uint index, bool unfiltered = false) {
        GLib.SequenceIter<BorderItemModel>? iter = null;
    ...
    public void set_sort_func (GLib.CompareDataFunc<BorderItemModel> function) {
