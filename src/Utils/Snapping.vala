...
public class Akira.Utils.Snapping : Object {
    ...
    public struct SnapGrid {
        ...
        public Gee.TreeMap<int, SnapMeta> v_snaps;
        public Gee.TreeMap<int, SnapMeta> h_snaps;
    }
    ...
    public static SnapGrid snap_grid_from_canvas (
        ...
        var grid = SnapGrid ();
        grid.v_snaps = new Gee.TreeMap<int, SnapMeta> ();
        grid.h_snaps = new Gee.TreeMap<int, SnapMeta> ();
    ...
    public static SnapMatchData generate_snap_matches (
        ...
        var v_sel_snaps = new Gee.TreeMap<int, SnapMeta> ();
        var h_sel_snaps = new Gee.TreeMap<int, SnapMeta> ();
    ...
    private static void populate_horizontal_snaps (
        ...
        ref Gee.TreeMap<int, SnapMeta> s_map
    ) {
    ...
    private static void populate_snap_matches_from_list (
        Gee.TreeMap<int, SnapMeta> target_snap_list,
        Gee.TreeMap<int, SnapMeta> grid_snap_list,
